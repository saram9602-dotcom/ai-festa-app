...
function makePrompt({ experience, emotion, whenWhere, inciting, conflict, resolution }) {
  return `너는 초등학생 눈높이의 감동적 단편 소설 기획자야. 아래 정보를 바탕으로
[제목], [줄거리(발단-전개-위기-절정-결말)], [핵심 메시지]를 한국어로 500~700자 내외로 작성해줘.
- 인상 깊었던 경험: ${experience}
- 감정: ${emotion}
- 시간/장소: ${whenWhere}
- 발단: ${inciting}
- 가장 큰 문제: ${conflict}
- 해결: ${resolution}
작성 규칙: 1) 초등학생도 이해하기 쉽게, 2) 따뜻하고 긍정적 톤, 3) 문단 나눔은 2~3개.`;
}
